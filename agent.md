...
| `PET_MATCH_API_URL` | Matching de mascotas apagado; las fotos se guardan igual. El servicio (pet-matcher) vive en un repo separado, no en este monorepo — [`github.com/encontradosco/pet-matcher`](https://github.com/encontradosco/pet-matcher) (privado). Sin desplegar todavía en ningún host — ver la sección de infraestructura en el PR que agrega mascotas. |
