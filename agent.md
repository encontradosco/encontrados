...
| `PET_MATCH_API_URL` | Matching de mascotas apagado; las fotos se guardan igual. El servicio (pet-matcher) vive en un repo separado, no en este monorepo — [`github.com/yesid-lopez/pet-matcher`](https://github.com/yesid-lopez/pet-matcher) (privado). |
